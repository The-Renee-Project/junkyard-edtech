...
def main():
    ...
    with open(DATA_PATH, 'r') as f:
        ...
        #plt.savefig('clpeak_res/global_memory_bandwidth.png')
        plt.close()
        ...
        #plt.savefig('clpeak_res/single_precision_compute.png')
        plt.close()
        ...
        #plt.savefig('clpeak_res/half_precision_compute.png')
        plt.close()
        ...
        #plt.savefig('clpeak_res/integer_compute.png')
        plt.close()
        ...
        plt.tight_layout()
        #plt.savefig('clpeak_res/transfer_bandwidth.png')
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('compute_performance.png')
        plt.close()
...
#        create_roofline_plot(MAX_TFLOPS * 1000, MAX_BANDWIDTH, clpeak_roofline_data, 'Roofline Plot', 'clpeak_res/clpeak_roofline.png')
